...
parser.add_argument('--robot_name', help="which robot should be started", default="cssgra")
...
if args.void_controller:
    ...
    r = RobotController(ros_active=True, recognize=args.recognize, camera_active=(not args.disable_camera), robot="cssgra")
    while not rospy.is_shutdown():
        r.step()
